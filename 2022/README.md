Disclaimer: I am a Python developer who had zero experience with Golang or Rust going into this. I'm learning as I go (lol); but if you're copying my work, just know that my Go/Rust are probably not going to be optimal and I probably write them with a Python accent.
...
Day 4: regex and if/and/or logic
  ...
  - Rust: 22ms
    - I stopped compiling rust with rustc and instead started using cargo. This was necessary because of the regex, but I'm glad that I moved over. Not sure why this made the runtime suddenly slower than go, probably something else I'm doing that's inefficient
***
...
Day 16: 
  - Python: DNF
    - This one got the best of me the day that I tried it. Will come back with a fresh headspace and try again later
***
